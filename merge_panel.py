    ...
    def run(self):
        ...
        for obj in self.objects:
            ...
            for page in range(pdf_reader.getNumPages()):
                ...
                wx.CallAfter(publish.sendMessage, "update", msg=page_count)
                page_count += 1
        ...
        wx.CallAfter(publish.sendMessage, "close")
...
class MergeGauge(wx.Gauge):
    ...
    def __init__(self, parent, range):
        ...
        publish.subscribe(self.update_progress, "update")
...
class MergeProgressDialog(wx.Dialog):
    ...
    def __init__(self, objects, path):
        ...
        publish.subscribe(self.close, "close")
...
class MergePanel(wx.Panel):
    ...
    def create_ui(self):
        ...
        self.pdf_olv = ObjectListView(self, style=wx.LC_REPORT | wx.SUNKEN_BORDER)
    ...
    def on_move(self, event):
        ...
        if current_selection:
            ...
            new_index = self.get_new_index(label.lower(), index, data)
